                                                     ...
                                                     const bool lineWrapped) noexcept
{
    ...
    const auto lastNonSpace = foundNonspace ? 0 : 1;
    ...
    const auto numSpaces = gsl::narrow_cast<til::CoordType>(cchLine - lastNonSpace - (foundNonspace ? 1 : 0));
    ...
    const auto cchActual = removeSpaces ? lastNonSpace : cchLine;
